...
const putSensor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield sensor.update({ type, facilityId, statusId });
...
const getSummary3 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Fetch all status names to ensure we can fill in 0 counts
        const statuses = yield sensor_status_1.Status.findAll({
            attributes: ["name"],
        });
        ...
        const sensors = yield sensor_1.Sensor.findAll({
            attributes: [
                "type",
                [connection_1.default.fn("COUNT", connection_1.default.col("sensor.id")), "count"],
            ],
            include: [
                {
                    model: sensor_status_1.Status,
        ...
        const summary = sensors.reduce((acc, sensor) => {
            var _a;
            const sensorData = sensor.get();
            const sensorType = sensorData.type;
            const statusName = (_a = sensorData.status) === null || _a === void 0 ? void 0 : _a.get("name");
...
exports.getSummary3 = getSummary3;
const sensorByStatus2 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Fetch all statuses along with the count of associated sensors
        const statuses = yield sensor_status_1.Status.findAll({
            attributes: [
                "name",
                [connection_1.default.fn("COUNT", connection_1.default.col("sensors.id")), "sensorCount"],
            ],
            include: [
                {
        ...
        statuses.forEach((status) => {
            const statusName = status.get("name");
            const sensorCount = status.get("sensorCount");
